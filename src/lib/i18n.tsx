...
const dict: Record<string, { ar: string; en: string }> = {
  ...
  cashbox_balance_hint: { ar: "الرصيد المحسوب من جميع الحركات المالية المسجلة.", en: "Balance calculated from all recorded cash movements." },
  cashbox_movements: { ar: "حركات الخزنة", en: "Cashbox movements" },
  cashbox_entry: { ar: "حركة خزنة يدوية", en: "Manual cashbox entry" },
  cashbox_direction: { ar: "اتجاه الحركة", en: "Transaction direction" },
  cash_in: { ar: "إيداع / دخول", en: "Cash in" },
  cash_out: { ar: "سحب / خروج", en: "Cash out" },
  cashbox_customer_payment: { ar: "تحصيل من عميل", en: "Customer payment" },
  cashbox_expense: { ar: "مصروف", en: "Expense" },
  cashbox_supplier_payment: { ar: "سداد مورد", en: "Supplier payment" },
  cashbox_deposit: { ar: "إيداع يدوي", en: "Manual deposit" },
  cashbox_withdrawal: { ar: "سحب يدوي", en: "Manual withdrawal" },
  cashbox_adjustment: { ar: "تسوية", en: "Adjustment" },
  period_inflow: { ar: "الدخول خلال الفترة", en: "Period inflow" },
  period_outflow: { ar: "الخروج خلال الفترة", en: "Period outflow" },
  customer_receivables: { ar: "ديون العملاء", en: "Customer receivables" },
  supplier_debt: { ar: "ديون الموردين", en: "Supplier debt" },
  new_supplier_bill: { ar: "فاتورة مورد جديدة", en: "New supplier bill" },
  supplier_payment: { ar: "سداد فاتورة المورد", en: "Supplier bill payment" },
  pay: { ar: "سداد", en: "Pay" },
  supplier_required: { ar: "اختر المورد", en: "Select a supplier" },
  invalid_payment_amount: { ar: "مبلغ السداد غير صالح أو يتجاوز الرصيد المستحق", en: "Invalid payment amount or amount exceeds the outstanding balance" },
