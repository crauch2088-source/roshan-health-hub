...
export const QUICK_COMPLAINTS: QuickOption[] = [
  ...
  { en: "Vomiting", ar: "قيء" },
  { en: "Diarrhea", ar: "إسهال" },/** * Static clinical option lists for the consultation workspace. * * These are UI catalogues / pick-lists only. They are NOT protocols, * recommendations or default patient data — nothing here is written to the * database unless the doctor actively selects it. */
